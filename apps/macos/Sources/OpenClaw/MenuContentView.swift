...
/// Menu contents for the OpenHand menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About OpenHand") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "OpenHand Not Configured"
        case .remote:
            "Remote OpenHand Active"
        case .local:
            "OpenHand Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openhandSelectSettingsTab, object: tab)
        }
    }

...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openhand", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenHand windows, but below the system’s pop-up menus.

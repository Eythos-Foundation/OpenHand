...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.openhand", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenHandPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenHandPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

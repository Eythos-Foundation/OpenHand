...
private let onboardingWizardLogger = Logger(subsystem: "ai.openhand", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between OpenHandProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = OpenHandProtocol.AnyCodable

...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openhand", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenHandConfigFile.defaultWorkspaceURL() }

...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openhandSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenHandPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenHandPaths.stateDirURL.path
...
extension Notification.Name {
    static let openhandSelectSettingsTab = Notification.Name("openhandSelectSettingsTab")
}

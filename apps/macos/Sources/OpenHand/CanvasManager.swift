...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.openhand", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenHand/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__openhand__/a2ui/").absoluteString + "?platform=macos"
    }

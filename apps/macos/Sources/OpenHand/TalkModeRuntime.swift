...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openhand", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openhand", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenHandChatMessage] = messages.compactMap { item in

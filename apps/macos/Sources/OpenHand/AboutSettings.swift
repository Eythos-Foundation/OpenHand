...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/Eythos-Foundation/OpenHand") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/Eythos-Foundation/OpenHand")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openhand.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenHandBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenHandBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenHandGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenHandGitCommit") as? String) ??
            "unknown"
    }

...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenHand"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openhand.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OpenHandChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openhand@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenHandChatViewModel(

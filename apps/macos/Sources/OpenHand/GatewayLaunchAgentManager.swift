...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openhand", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openhand/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openhandCommand(
            subcommand: "gateway",

...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenHandConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenHandConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenHandConfigFile.loadDict()
            ...
            OpenHandConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openhand"
        state.remoteCliPath = ""
        return state
    }
}

...
import ai.openhand.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("OpenHand is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}

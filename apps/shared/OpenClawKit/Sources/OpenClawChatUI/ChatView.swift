...
@MainActor
public struct OpenHandChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpenHandChatViewModel
    ...
    public init(
        viewModel: OpenHandChatViewModel,
    ...
    private var visibleMessages: [OpenHandChatMessage] {
        let base: [OpenHandChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenHandChatMessage]) -> [OpenHandChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OpenHandChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OpenHandChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenHandChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenHandChatMessage) -> String {

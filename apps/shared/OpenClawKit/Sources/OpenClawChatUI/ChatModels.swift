...
public typealias OpenHandPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenHandPlatformImage = UIImage
#endif

public struct OpenHandChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenHandChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenHandChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenHandChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenHandChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenHandChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenHandChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenHandChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenHandChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenHandChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenHandChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenHandChatMessageContent].self, forKey: .content) {
...
public struct OpenHandChatHistoryPayload: Codable, Sendable {
...
public struct OpenHandSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenHandSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenHandSessionPreviewItem]
}

public struct OpenHandSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenHandSessionPreviewEntry]

    public init(ts: Int, previews: [OpenHandSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenHandChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenHandChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenHandAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenHandChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenHandGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenHandPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenHandPlatformImage?
...
public struct OpenHandChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OpenHandProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OpenHandProtocol.AnyCodable(identity.deviceId),
            "publicKey": OpenHandProtocol.AnyCodable(publicKey),
            "signature": OpenHandProtocol.AnyCodable(signature),
            "signedAt": OpenHandProtocol.AnyCodable(signedAtMs),
            "nonce": OpenHandProtocol.AnyCodable(nonce),
        ]
    }
}

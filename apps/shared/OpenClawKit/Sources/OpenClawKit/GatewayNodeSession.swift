...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.openhand", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.openhand", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenHandProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

...
public enum OpenHandCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenHandCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenHandCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

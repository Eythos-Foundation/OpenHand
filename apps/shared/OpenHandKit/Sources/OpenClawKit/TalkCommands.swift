...
public enum OpenHandTalkCommand: String, Codable, Sendable {
...
public struct OpenHandTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenHandTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

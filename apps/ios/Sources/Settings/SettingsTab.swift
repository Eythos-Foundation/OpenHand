...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OpenHandLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = OpenHandLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.openhand.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected OpenHand agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while OpenHand is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for OpenHand. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(OpenHandLocationMode.off.rawValue)
                            Text("While Using").tag(OpenHandLocationMode.whileUsing.rawValue)
                            Text("Always").tag(OpenHandLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while OpenHand is open.")
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = OpenHandLocationMode(rawValue: newValue) else { return }
                Task {

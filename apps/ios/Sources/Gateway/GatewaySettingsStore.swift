...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.openhand.gateway"
    private static let nodeService = "ai.openhand.node"
    private static let talkService = "ai.openhand.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openhand.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openhand.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openhand-gateway.log")
    }

...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenHandPhotosLatestParams) async throws -> OpenHandPhotosLatestPayload {
        ...
        var results: [OpenHandPhotoPayload] = []
        ...
        return OpenHandPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenHandPhotoPayload
    {

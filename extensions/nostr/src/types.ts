...
function resolveConfiguredDefaultNostrAccountId(cfg: OpenHandConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OpenHandConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OpenHandConfig): string {

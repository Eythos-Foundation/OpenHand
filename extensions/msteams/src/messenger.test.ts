...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "openhand/plugin-sdk";
...
import { resolvePreferredOpenHandTmpDir } from "../../../src/infra/tmp-openhand-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredOpenHandTmpDir(), "msteams-mention-"));

...
// Default to OpenHand workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".openhand", "workspace", "media", "inbound");
 ...
 * Format matches OpenHand's expected attachment structure.
 */

...
export function listZalouserAccountIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenHandConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenHandConfig, accountId: string): ZalouserAccountConfig {

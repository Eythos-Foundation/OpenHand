...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "openhand/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: OpenHandPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: OpenHandPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;

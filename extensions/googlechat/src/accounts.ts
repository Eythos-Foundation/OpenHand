import { isSecretRef } from "openhand/plugin-sdk";
...
export function listGoogleChatAccountIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenHandConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenHandConfig): ResolvedGoogleChatAccount[] {

...
export function listMattermostAccountIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenHandConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenHandConfig): ResolvedMattermostAccount[] {

...
import type { ReplyPayload, OpenHandConfig } from "openhand/plugin-sdk";
import { createReplyPrefixOptions } from "openhand/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenHandConfig;

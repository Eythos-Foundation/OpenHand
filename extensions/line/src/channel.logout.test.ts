import type { OpenHandConfig, PluginRuntime, ResolvedLineAccount } from "openhand/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: OpenHandConfig; accountId: string }): Promise<{

import type { OpenHandConfig } from "openhand/plugin-sdk";
import {
  DEFAULT_ACCOUNT_ID,
  normalizeAccountId,
  normalizeOptionalAccountId,
} from "openhand/plugin-sdk/account-id";
...
export function listZaloAccountIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: OpenHandConfig): string {
...
function mergeZaloAccountConfig(cfg: OpenHandConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenHandConfig): ResolvedZaloAccount[] {

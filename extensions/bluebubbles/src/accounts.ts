...
export function listBlueBubblesAccountIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenHandConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenHandConfig): ResolvedBlueBubblesAccount[] {

...
import { resolveChannelMediaMaxBytes, type OpenHandConfig } from "openhand/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenHandConfig; accountId?: string }): string[] {

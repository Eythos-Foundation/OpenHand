...
This directory contains the **BlueBubbles external channel plugin** for OpenHand.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openhand/plugin-sdk` helpers.

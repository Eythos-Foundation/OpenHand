    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          OPENHAND_TEST_FAST: "1",
        };
        delete env.OPENHAND_HOME;
        delete env.OPENHAND_STATE_DIR;
        delete env.OPENHAND_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "openhand.mjs");

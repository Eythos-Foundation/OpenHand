...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `openhand/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "openhand/plugin-sdk/account-id",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "account-id.ts"),
      },
      {
        find: "openhand/plugin-sdk/keyed-async-queue",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "keyed-async-queue.ts"),
      },
      {
        find: "openhand/plugin-sdk",

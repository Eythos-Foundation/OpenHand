...
function mergeSignalAccountConfig(cfg: OpenHandConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenHandConfig): ResolvedSignalAccount[] {

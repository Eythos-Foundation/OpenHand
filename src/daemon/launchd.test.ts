...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.openhand.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPENHAND_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.openhand.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.openhand.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPENHAND_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openhand.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPENHAND_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPENHAND_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openhand.jbphoenix.plist",
    },
    {
      name: "prefers OPENHAND_LAUNCHD_LABEL over OPENHAND_PROFILE",
      env: {
        HOME: "/Users/test",
        OPENHAND_PROFILE: "jbphoenix",
        OPENHAND_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OPENHAND_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPENHAND_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPENHAND_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPENHAND_PROFILE: "myprofile",
        OPENHAND_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.openhand.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

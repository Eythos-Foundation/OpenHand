...
export function listWhatsAppAuthDirs(cfg: OpenHandConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenHandConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenHandConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenHandConfig): ResolvedWhatsAppAccount[] {

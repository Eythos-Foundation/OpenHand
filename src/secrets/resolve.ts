...
function resolveResolutionLimits(config: OpenHandConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OpenHandConfig): SecretProviderConfig {

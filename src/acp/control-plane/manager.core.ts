...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OpenHandConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OpenHandConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OpenHandConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OpenHandConfig }): Promise<void> {

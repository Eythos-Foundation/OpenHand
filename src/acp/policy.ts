...
export function isAcpEnabledByPolicy(cfg: OpenHandConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OpenHandConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OpenHandConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OpenHandConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OpenHandConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OpenHandConfig, agentId: string): boolean {

...
export function listBindings(cfg: OpenHandConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OpenHandConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenHandConfig) {

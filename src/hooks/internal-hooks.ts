/**
 * Hook system for OpenHand agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __openhand_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__openhand_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());

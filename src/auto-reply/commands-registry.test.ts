...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openhand", { botUsername: "openhand" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openhand args", {
        botUsername: "openhand",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openhand: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openhand" })).toBe(
      "/help@otherbot",
    );
  });

...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bopenhand\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "OpenHand",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[OpenHand] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;

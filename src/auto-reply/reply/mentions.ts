...
function resolveMentionPatterns(cfg: OpenHandConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenHandConfig | undefined, agentId?: string): RegExp[] {

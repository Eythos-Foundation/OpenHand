...
function resolveAcpStreamCoalesceIdleMs(cfg: OpenHandConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OpenHandConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OpenHandConfig): AcpProjectionSettings {

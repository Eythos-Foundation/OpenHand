...
export const PLUGIN_MANIFEST_FILENAME = "openhand.plugin.json";
...
// package.json "openhand" metadata (used for onboarding/catalog)
...
export type OpenHandPackageManifest = {
  extensions?: string[];
...
): OpenHandPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }

...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/openhand/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhand/extensions",
        global: "/Users/x/.openhand/extensions",
        workspace: "/Users/x/ws/.openhand/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.openhand/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhand/extensions",
        global: "/Users/x/.openhand/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.openhand/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhand/extensions",
        global: "/Users/x/.openhand/extensions",

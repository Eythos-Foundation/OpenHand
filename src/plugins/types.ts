...
export type OpenHandPluginConfigSchema = {
...
export type OpenHandPluginToolContext = {
...
export type OpenHandPluginToolFactory = (
  ctx: OpenHandPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OpenHandPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OpenHandPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OpenHandConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OpenHandPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OpenHand configuration */
  config: OpenHandConfig;
 ...
 */
export type OpenHandPluginCommandDefinition = {
...
export type OpenHandPluginHttpRouteAuth = "gateway" | "plugin";
export type OpenHandPluginHttpRouteMatch = "exact" | "prefix";

export type OpenHandPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type OpenHandPluginHttpRouteParams = {
  path: string;
  handler: OpenHandPluginHttpRouteHandler;
  auth: OpenHandPluginHttpRouteAuth;
  match?: OpenHandPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type OpenHandPluginCliContext = {
  program: Command;
  config: OpenHandConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OpenHandPluginCliRegistrar = (ctx: OpenHandPluginCliContext) => void | Promise<void>;

export type OpenHandPluginServiceContext = {
  config: OpenHandConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OpenHandPluginService = {
  id: string;
  start: (ctx: OpenHandPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OpenHandPluginServiceContext) => void | Promise<void>;
};

export type OpenHandPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OpenHandPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OpenHandPluginConfigSchema;
  register?: (api: OpenHandPluginApi) => void | Promise<void>;
  activate?: (api: OpenHandPluginApi) => void | Promise<void>;
};

export type OpenHandPluginModule =
  | OpenHandPluginDefinition
  | ((api: OpenHandPluginApi) => void | Promise<void>);

export type OpenHandPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OpenHandPluginToolFactory,
    opts?: OpenHandPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OpenHandPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: OpenHandPluginHttpRouteParams) => void;
  registerChannel: (registration: OpenHandPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OpenHandPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OpenHandPluginService) => void;
   ...
   */
  registerCommand: (command: OpenHandPluginCommandDefinition) => void;

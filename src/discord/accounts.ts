...
function mergeDiscordAccountConfig(cfg: OpenHandConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OpenHandConfig): ResolvedDiscordAccount[] {

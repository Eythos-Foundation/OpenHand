...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenHandConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenHandConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenHandConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

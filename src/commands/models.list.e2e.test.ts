...
const ensureOpenHandModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOpenHandAgentDir = vi.fn().mockReturnValue("/tmp/openhand-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/openhand-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOpenHandModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOpenHandAgentDir,
}));

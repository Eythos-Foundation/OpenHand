...
export function applyOpencodeZenProviderConfig(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyOpencodeZenConfig(cfg: OpenHandConfig): OpenHandConfig {

...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.openhand.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("openhand hooks list")}`,
      `  ${formatCliCommand("openhand hooks enable <name>")}`,
      `  ${formatCliCommand("openhand hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

...
function resolveDefaultAccountId(cfg: OpenHandConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenHandConfig): boolean {
...
export function summarizeBindings(cfg: OpenHandConfig, bindings: AgentBinding[]): string[] {

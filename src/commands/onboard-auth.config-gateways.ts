...
export function applyVercelAiGatewayProviderConfig(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenHandConfig): OpenHandConfig {

...
let originalOpenHandTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOpenHandTestConsole = process.env.OPENHAND_TEST_CONSOLE;
  process.env.OPENHAND_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpenHandTestConsole === undefined) {
    delete process.env.OPENHAND_TEST_CONSOLE;
  } else {
    process.env.OPENHAND_TEST_CONSOLE = originalOpenHandTestConsole;
  }

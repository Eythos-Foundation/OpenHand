...
function asOpenHandConfig(config: Partial<OpenHandConfig>): OpenHandConfig {
  return config as OpenHandConfig;
}

function createToolConfig() {
  return asOpenHandConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OpenHandConfig = createToolConfig()) {

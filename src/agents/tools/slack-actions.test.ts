...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OpenHandConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OpenHandConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OpenHandConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();

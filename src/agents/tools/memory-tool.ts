...
function resolveMemoryToolContext(options: { config?: OpenHandConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OpenHandConfig): MemoryCitationsMode {

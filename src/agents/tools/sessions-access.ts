...
export function resolveSessionToolsVisibility(cfg: OpenHandConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OpenHandConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OpenHandConfig): AgentToAgentPolicy {

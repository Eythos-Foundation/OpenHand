...
type AgentEntry = NonNullable<NonNullable<OpenHandConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: OpenHandConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OpenHandConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpenHandConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OpenHandConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: OpenHandConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpenHandConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OpenHandConfig, agentId: string) {
  const id = normalizeAgentId(agentId);

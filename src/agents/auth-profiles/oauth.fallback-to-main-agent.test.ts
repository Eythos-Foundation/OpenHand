...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenHandAgentDir() returns mainAgentDir
    process.env.OPENHAND_STATE_DIR = tmpDir;
    process.env.OPENHAND_AGENT_DIR = mainAgentDir;

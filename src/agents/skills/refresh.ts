...
function resolveWatchPaths(workspaceDir: string, config?: OpenHandConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenHandConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenHandConfig }) {

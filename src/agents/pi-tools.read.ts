...
function resolveAdaptiveReadMaxBytes(options?: OpenHandReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenHandReadTool(base, {
...
export function createOpenHandReadTool(
  base: AnyAgentTool,
  options?: OpenHandReadToolOptions,
): AnyAgentTool {

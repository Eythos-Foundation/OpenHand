...
export const DEFAULT_SANDBOX_IMAGE = "openhand-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openhand-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openhand-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openhand-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openhand-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "openhand-sandbox-browser";

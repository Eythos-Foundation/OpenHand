...
const CLEANUP_STATE_KEY = Symbol.for("openhand.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openhand.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openhand.sessionWriteLockWatchdogState");

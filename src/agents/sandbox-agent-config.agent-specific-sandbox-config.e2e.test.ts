...
async function resolveContext(config: OpenHandConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OpenHandConfig {
  return {
    agents: {
      defaults: {
        sandbox: {

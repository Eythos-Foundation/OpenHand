...
const defaultTools = createOpenHandCodingTools({ senderIsOwner: true });
...
describe("createOpenHandCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: OpenHandConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createOpenHandCodingTools({
    ...
    const anthropicTools = createOpenHandCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: OpenHandConfig = {
      tools: {
        exec: {
    ...
    const allowed = createOpenHandCodingTools({
    ...
    const denied = createOpenHandCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createOpenHandCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });

...
function resolveAvatarSource(cfg: OpenHandConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenHandConfig, agentId: string): AgentAvatarResolution {

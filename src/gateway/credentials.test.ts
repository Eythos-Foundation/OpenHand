...
function cfg(input: Partial<OpenHandConfig>): OpenHandConfig {
  return input as OpenHandConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<OpenHandConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  OPENHAND_GATEWAY_TOKEN: "env-token",
  OPENHAND_GATEWAY_PASSWORD: "env-password",

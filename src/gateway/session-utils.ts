...
import { type OpenHandConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenHandConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenHandConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenHandConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenHandConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenHandConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OpenHandConfig): GatewaySessionsDefaults {

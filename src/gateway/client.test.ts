...
function expectSecurityConnectError(
  ...
  expect(error.message).toContain("openhand doctor --fix");
...
describe("GatewayClient security checks", () => {
  const envSnapshot = captureEnv(["OPENHAND_ALLOW_INSECURE_PRIVATE_WS"]);
  ...
  it("allows ws:// to private addresses only with OPENHAND_ALLOW_INSECURE_PRIVATE_WS=1", () => {

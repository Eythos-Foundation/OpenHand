      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["openhand gateway run", "Run the gateway in the foreground."],
            ["openhand gateway status", "Show service status and probe reachability."],
            ["openhand gateway discover", "Find local and wide-area gateway beacons."],
            ["openhand gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.openhand.ai/cli/gateway")}\n`,
      ),
  );

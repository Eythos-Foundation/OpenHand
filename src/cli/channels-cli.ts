    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openhand channels list", "List configured channels and auth profiles."],
          ["openhand channels status --probe", "Run channel status checks and probes."],
          [
            "openhand channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["openhand channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.openhand.ai/cli/channels",
        )}\n`,
    );

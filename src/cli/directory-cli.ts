    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openhand directory self --channel slack", "Show the connected account identity."],
          [
            'openhand directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openhand directory groups list --channel discord", "List available groups/channels."],
          [
            "openhand directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.openhand.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

...
function resolveAnthropicDefaultAuthMode(cfg: OpenHandConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyTalkApiKey(config: OpenHandConfig): OpenHandConfig {
...
export function applyTalkConfigNormalization(config: OpenHandConfig): OpenHandConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OpenHandConfig): OpenHandConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyLoggingDefaults(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyContextPruningDefaults(cfg: OpenHandConfig): OpenHandConfig {
...
export function applyCompactionDefaults(cfg: OpenHandConfig): OpenHandConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

...
export function listChannelMessageActions(cfg: OpenHandConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpenHandConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OpenHandConfig): boolean {

...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: OpenHandConfig): string | undefined {
  ...
  function listAccountIds(cfg: OpenHandConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OpenHandConfig): string {

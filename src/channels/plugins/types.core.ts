...
export type ChannelAgentToolFactory = (params: { cfg?: OpenHandConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenHandConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenHandConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenHandConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenHandConfig }) => boolean;

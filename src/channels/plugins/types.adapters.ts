...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OpenHandConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: OpenHandConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OpenHandConfig;
    accountId: string;
    enabled: boolean;
  }) => OpenHandConfig;
  deleteAccount?: (params: { cfg: OpenHandConfig; accountId: string }) => OpenHandConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OpenHandConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OpenHandConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OpenHandConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OpenHandConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OpenHandConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.openhand.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OpenHandConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};

...
export const A2UI_PATH = "/__openhand__/a2ui";

export const CANVAS_HOST_PATH = "/__openhand__/canvas";

export const CANVAS_WS_PATH = "/__openhand__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openhandCanvasA2UIAction.postMessage(...)
  // - Android: window.openhandCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openhandCanvasA2UIAction"];
  ...
  globalThis.OpenHand = globalThis.OpenHand ?? {};
  globalThis.OpenHand.postMessage = postToNode;
  globalThis.OpenHand.sendUserAction = sendUserAction;
  globalThis.openhandPostMessage = postToNode;
  globalThis.openhandSendUserAction = sendUserAction;

...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpenHandConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenHandConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__openhandMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__openhandMcporterColdStartWarned;
  });

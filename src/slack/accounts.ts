...
function mergeSlackAccountConfig(cfg: OpenHandConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenHandConfig): ResolvedSlackAccount[] {

...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.openhand/openhand.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von openhand dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {

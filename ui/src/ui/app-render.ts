      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="OpenHand" />
            </div>
            <div class="brand-text">
              <div class="brand-title">OPENHAND</div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${openHandVersion}</span>
          </div>
          <div class="pill">

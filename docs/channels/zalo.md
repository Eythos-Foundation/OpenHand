...
- Install via CLI: `openhand plugins install @openhand/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openhand plugins install ./extensions/zalo`
   - From npm (if published): `openhand plugins install @openhand/zalo`
...
- Approve via:
  - `openhand pairing list zalo`
  - `openhand pairing approve zalo <CODE>`
...
- Example: `openhand message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openhand channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openhand logs --follow`

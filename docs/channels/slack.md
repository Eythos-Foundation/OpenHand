...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenHand HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openhand pairing approve slack <code>`.
...
OpenHand supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenHand falls back to normal delivery for remaining payloads.

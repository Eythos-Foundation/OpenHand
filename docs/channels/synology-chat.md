---
summary: "Synology Chat webhook setup and OpenHand config"
read_when:
  - Setting up Synology Chat with OpenHand
...
```bash
openhand plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your OpenHand gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in OpenHand.
...
- Pairing approvals work with:
  - `openhand pairing list synology-chat`
  - `openhand pairing approve synology-chat <CODE>`
...
```bash
openhand message send --channel synology-chat --target 123456 --text "Hello from OpenHand"
openhand message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```

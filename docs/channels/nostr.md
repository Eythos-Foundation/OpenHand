...
read_when:
  - You want OpenHand to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OpenHand to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`openhand onboard`) and `openhand channels add` list optional channel plugins.
...
```bash
openhand plugins install @openhand/nostr
```

Use a local checkout (dev workflows):

```bash
openhand plugins install --link <path-to-openhand>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "openhand",
        "displayName": "OpenHand",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "openhand@example.com",
        "lud16": "openhand@example.com"
      }
    }
  }
}

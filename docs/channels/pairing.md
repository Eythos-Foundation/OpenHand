...
read_when:
  ...
  - Reviewing OpenHand security posture
title: "Pairing"
---

# Pairing

“Pairing” is OpenHand’s explicit **owner approval** step.
...
Stored under `~/.openhand/credentials/`:
...
3. On your phone, open the OpenHand iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `openhand nodes pending/approve`) is a

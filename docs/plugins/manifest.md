...
read_when:
  - You are building a OpenHand plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openhand.plugin.json)

Every plugin **must** ship a `openhand.plugin.json` file in the **plugin root**.
OpenHand uses this manifest to validate configuration **without executing plugin

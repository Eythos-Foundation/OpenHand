---
summary: "First-run onboarding flow for OpenHand (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenHand">
...
<Step title="CLI">
  ...
  The app can install the global `openhand` CLI via npm/pnpm so terminal

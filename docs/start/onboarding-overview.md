---
summary: "Overview of OpenHand onboarding options and flows"
read_when:
...
OpenHand supports multiple onboarding paths depending on where the Gateway runs
...
- [`openhand onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenHand app when you want a fully guided setup on macOS. Docs:

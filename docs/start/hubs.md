---
summary: "Hubs that link to every OpenHand doc"
read_when:
...
<Note>
If you are new to OpenHand, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenHand assistant](/start/openhand)

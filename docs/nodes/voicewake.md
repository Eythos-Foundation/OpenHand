...
OpenHand treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.openhand/settings/voicewake.json`

Shape:

```json
{ "triggers": ["openhand", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

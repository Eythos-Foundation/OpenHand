---
summary: "VPS hosting hub for OpenHand (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `OPENHAND_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `OPENHAND_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/openhand-compile-cache`

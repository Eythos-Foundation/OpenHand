---
summary: "Use Synthetic's Anthropic-compatible API in OpenHand"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenHand registers it as the
...
Note: OpenHand's Anthropic client appends `/v1` to the base URL, so use

...
You can point OpenHand at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenHand
...
- [Anthropic provider](/providers/anthropic) - Native OpenHand integration with Claude setup-token or API keys

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenHand"
read_when:
  - You want Xiaomi MiMo models in OpenHand
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenHand uses

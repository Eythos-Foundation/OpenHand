---
summary: "Use Qwen OAuth (free tier) in OpenHand"
read_when:
  - You want to use Qwen with OpenHand
...
If you already logged in with the Qwen Code CLI, OpenHand will sync credentials

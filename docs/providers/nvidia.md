---
summary: "Use NVIDIA's OpenAI-compatible API in OpenHand"
read_when:
  - You want to use NVIDIA models in OpenHand
...
openhand onboard --auth-choice skip
openhand models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

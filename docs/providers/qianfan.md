---
summary: "Use Qianfan's unified API to access many models in OpenHand"
read_when:
...
3. OpenHand installed on your system
...
4. Copy the API key for use with OpenHand

## CLI setup

```bash
openhand onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenHand Configuration](/gateway/configuration)

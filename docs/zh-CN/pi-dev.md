...
本指南总结了在 OpenHand 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenHand 状态目录下。默认为 `~/.openhand`。如果设置了 `OPENHAND_STATE_DIR`，则使用该目录。
...
- https://docs.openhand.ai/testing
- https://docs.openhand.ai/start/getting-started

...
OpenHand ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenHand also aligns
the install method:
...
When you switch channels with `openhand update`, OpenHand also syncs plugin sources:

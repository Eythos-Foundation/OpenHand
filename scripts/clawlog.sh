...
show_usage() {
    cat << EOF
clawlog - OpenHand Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenHand logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenHand logs flow through the macOS unified log (subsystem: ai.openhand).

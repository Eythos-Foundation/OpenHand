...
# Output:
# - dist/OpenHand.app
# - dist/OpenHand-<version>.zip
# - dist/OpenHand-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.openhand.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenHand.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenHand-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenHand-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenHand-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenHand-$VERSION.dSYM.zip"

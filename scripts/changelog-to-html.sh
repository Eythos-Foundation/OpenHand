...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenHand $VERSION</h2>"
  echo "<p>Latest OpenHand update.</p>"
  echo "<p><a href=\"https://github.com/openhand/openhand/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
